  ...
  return (
    ...
    >
      <div className="text-2xl font-normal tracking-tight">
        Deliveroo <span className="font-bold text-yellow-500">FOOD</span>
      </div>
      ...
      <div className="flex space-x-4">
        ...
        <button className="px-6 py-2 bg-yellow-500 text-white font-medium rounded-full hover:bg-yellow-500 transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-50">
          Sign Up
        </button>
      </div>
    </nav>
