...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      await MySwal.fire({
        ...
        html: <span style={{ color: '#aaa' }}>{err.response?.data?.message || 'Invalid credentials'}</span>,
        icon: 'error',
        background: 'rgba(20, 20, 25, 0.98)',
        backdrop: `
          rgba(5,5,5,0.73)
  ...
  return (
    <div className={`min-h-screen flex flex-col md:flex-row bg-gray-50 ${isBlurred ? 'blur-sm' : ''} transition-all`}>
      ...
      <div className="md:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-lg">
            Join our community of food lovers and enjoy the best dining experience with just a few clicks.
          </p>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-sm text-[#ff5823] hover:underline">
                  Forgot password?
                </a>
              </div>
            ...
            <div className="mt-6 text-center text-sm text-gray-600">
              ...
              <a href="/register" className="font-medium text-[#ff5823] hover:underline">
                Sign up
              </a>
            </div>
          </div>
