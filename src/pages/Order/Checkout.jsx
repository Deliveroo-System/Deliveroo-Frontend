...
function Checkout() {
  ...
  const handlePlaceOrder = async (paymentId = null, method = "cod") => {
    ...
    try {
      // Simulate order saving here (connect your API later)
      await new Promise(res => setTimeout(res, 1000));
      
      Swal.fire("Success!", `Order placed with ${method === "cod" ? "Cash on Delivery" : "PayPal"}`, "success")
        .then(() => navigate("/order/restaurant"));
    } catch (error) {
              ...
              <div className="max-w-lg mx-auto">
                ...
                <div className="flex justify-between mb-8">
                  <div className="flex flex-col items-center">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 1 ? 'bg-black text-white' : 'bg-gray-200 text-gray-600'}`}>1</div>
                    <span className={`mt-2 text-xs font-medium ${currentStep >= 1 ? 'text-black' : 'text-gray-400'}`}>Cart</span>
                  </div>
                  <div className={`w-full border-t-2 my-auto mx-2 ${currentStep >= 2 ? 'border-black' : 'border-gray-200'}`}></div>
                  <div className="flex flex-col items-center">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 2 ? 'bg-black text-white' : 'bg-gray-200 text-gray-600'}`}>2</div>
                    <span className={`mt-2 text-xs font-medium ${currentStep >= 2 ? 'text-black' : 'text-gray-400'}`}>Details</span>
                  </div>
                  <div className={`w-full border-t-2 my-auto mx-2 ${currentStep >= 3 ? 'border-black' : 'border-gray-200'}`}></div>
                  <div className="flex flex-col items-center">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= 3 ? 'bg-black text-white' : 'bg-gray-200 text-gray-600'}`}>3</div>
                    <span className={`mt-2 text-xs font-medium ${currentStep >= 3 ? 'text-black' : 'text-gray-400'}`}>Payment</span>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="relative">
                        <label className="text-xs font-medium text-gray-600 ml-3 mb-1 block">Full Name</label>
                        <input
                          type="text"
                          name="name"
                      ...
                      <div className="relative">
                        <label className="text-xs font-medium text-gray-600 ml-3 mb-1 block">Phone Number</label>
                        <input
                          type="tel"
                          name="phone"
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      <div className="relative">
                        <label className="text-xs font-medium text-gray-600 ml-3 mb-1 block">Street Address</label>
                        <textarea
                          name="address"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="relative">
                          <label className="text-xs font-medium text-gray-600 ml-3 mb-1 block">City</label>
                          <input
                            type="text"
                            name="city"
                        ...
                        <div className="relative">
                          <label className="text-xs font-medium text-gray-600 ml-3 mb-1 block">ZIP Code</label>
                          <input
                            type="text"
                            name="zipCode"
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div 
                        className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${paymentMethod === 'paypal' ? 'border-black bg-gray-50' : 'border-gray-200 bg-white'}`}
                      ...
                      <div 
                        className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-black bg-gray-50' : 'border-gray-200 bg-white'}`}
              ...
              <div className="max-w-lg mx-auto">
                      ...
                      <div key={index} className="flex items-center space-x-4 bg-gray-800 p-3 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex justify-between mt-1">
                            ...
                            <span className="text-white">${(item.menuItemPrice * item.quantity).toFixed(2)}</span>
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                {paymentMethod === 'paypal' ? (
                  ...
                  <div className="mt-6 p-4 bg-gray-800 rounded-lg text-center">
                    <p className="text-gray-300">Please select a payment method</p>
                  </div>
                )}
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded-xl shadow-md flex items-center space-x-3 border border-gray-200">
            ...
            <div>
              <h4 className="font-medium text-gray-900 text-sm">Quality Guarantee</h4>
